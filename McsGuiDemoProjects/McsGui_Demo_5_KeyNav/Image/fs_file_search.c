...
{                                                                      /* filename, fileproperty, datalocation */
    ...
    { .dataOffset = 4038, .properties = 2, .width = 36, .height = 29 },    /* IRL-Logo_@B001, 10, 0 - SD */
    { .dataOffset = 8838, .properties = 2, .width = 39, .height = 32 },    /* IRL-Logo_@B002, 10, 0 - SD */
    { .dataOffset = 14220, .properties = 2, .width = 42, .height = 35 },    /* IRL-Logo_@B003, 10, 0 - SD */
    { .dataOffset = 20286, .properties = 2, .width = 46, .height = 37 },    /* IRL-Logo_@B004, 10, 0 - SD */
    { .dataOffset = 27168, .properties = 2, .width = 49, .height = 40 },    /* IRL-Logo_@B005, 10, 0 - SD */
    { .dataOffset = 34686, .properties = 2, .width = 52, .height = 43 },    /* IRL-Logo_@B006, 10, 0 - SD */
    { .dataOffset = 43230, .properties = 2, .width = 56, .height = 46 },    /* IRL-Logo_@B007, 10, 0 - SD */
    { .dataOffset = 52200, .properties = 2, .width = 59, .height = 48 },    /* IRL-Logo_@B008, 10, 0 - SD */
    { .dataOffset = 62286, .properties = 2, .width = 62, .height = 50 },    /* IRL-Logo_@B009, 10, 0 - SD */
    { .dataOffset = 72900, .properties = 2, .width = 65, .height = 54 },    /* IRL-Logo_@B010, 10, 0 - SD */
    { .dataOffset = 84810, .properties = 2, .width = 69, .height = 56 },    /* IRL-Logo_@B011, 10, 0 - SD */
    { .dataOffset = 97248, .properties = 2, .width = 72, .height = 59 },    /* IRL-Logo_@B012, 10, 0 - SD */
    { .dataOffset = 109992, .properties = 2, .width = 76, .height = 62 },    /* IRL-Logo_@B013, 10, 0 - SD */
    { .dataOffset = 124008, .properties = 2, .width = 79, .height = 64 },    /* IRL-Logo_@B014, 10, 0 - SD */
    { .dataOffset = 138462, .properties = 2, .width = 82, .height = 67 },    /* IRL-Logo_@B015, 10, 0 - SD */
    { .dataOffset = 154002, .properties = 2, .width = 86, .height = 69 },    /* IRL-Logo_@B016, 10, 0 - SD */
    { .dataOffset = 169986, .properties = 2, .width = 89, .height = 72 },    /* IRL-Logo_@B017, 10, 0 - SD */
    { .dataOffset = 186780, .properties = 2, .width = 92, .height = 75 },    /* IRL-Logo_@B018, 10, 0 - SD */
    { .dataOffset = 204552, .properties = 2, .width = 95, .height = 77 },    /* IRL-Logo_@B019, 10, 0 - SD */
    { .dataOffset = 222510, .properties = 2, .width = 100, .height = 80 },    /* IRL-Logo_@B020, 10, 0 - SD */
    { .dataOffset = 241938, .properties = 2, .width = 102, .height = 83 },    /* IRL-Logo_@B021, 10, 0 - SD */
    { .dataOffset = 261264, .properties = 2, .width = 105, .height = 85 },    /* IRL-Logo_@B022, 10, 0 - SD */
    { .dataOffset = 282492, .properties = 2, .width = 109, .height = 88 },    /* IRL-Logo_@B023, 10, 0 - SD */
    { .dataOffset = 302040, .properties = 1, .width = 30, .height = 30 },    /* NumInput_minus@A0, 1, 0 - SD */
    { .dataOffset = 303438, .properties = 1, .width = 30, .height = 30 },    /* NumInput_minus@A1, 1, 0 - SD */
    { .dataOffset = 304836, .properties = 1, .width = 30, .height = 30 },    /* NumInput_plus@A0, 1, 0 - SD */
    { .dataOffset = 306570, .properties = 1, .width = 30, .height = 30 },    /* NumInput_plus@A1, 1, 0 - SD */
    { .dataOffset = 308304, .properties = 1, .width = 22, .height = 31 },    /* Slider@A0, 1, 0 - SD */
    { .dataOffset = 308946, .properties = 1, .width = 22, .height = 31 },    /* Slider@A1, 1, 0 - SD */
    { .dataOffset = 309588, .properties = 0, .width = 128, .height = 128 },    /* IRL_Logo 128, 0, 0 - SD */
    { .dataOffset = 319668, .properties = 0, .width = 48, .height = 48 },    /* IRL_Logo_48, 0, 0 - SD */
    { .dataOffset = 323016, .properties = 1, .width = 480, .height = 236 },    /* Keyboard_lc@A0, 1, 0 - SD */
    { .dataOffset = 367446, .properties = 1, .width = 480, .height = 236 },    /* Keyboard_lc@A1, 1, 0 - SD */
    { .dataOffset = 411888, .properties = 1, .width = 480, .height = 236 },    /* Keyboard_num@A0, 1, 0 - SD */
    { .dataOffset = 451452, .properties = 1, .width = 480, .height = 236 },    /* Keyboard_num@A1, 1, 0 - SD */
    { .dataOffset = 491028, .properties = 1, .width = 480, .height = 84 },    /* Keyboard_textbox@A0, 1, 0 - SD */
    { .dataOffset = 492174, .properties = 1, .width = 480, .height = 84 },    /* Keyboard_textbox@A1, 1, 0 - SD */
    { .dataOffset = 493320, .properties = 1, .width = 480, .height = 236 },    /* Keyboard_uc@A0, 1, 0 - SD */
    { .dataOffset = 541782, .properties = 1, .width = 480, .height = 236 },    /* Keyboard_uc@A1, 1, 0 - SD */
