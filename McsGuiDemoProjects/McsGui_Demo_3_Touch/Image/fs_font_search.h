...
typedef enum
{
    FONT_KEY_ROBOTO_13_R_DEFAULT_TEXT = 0,
    FONT_KEY_ROBOTO_13_R_PANE_TEXT = 1,
    FONT_KEY_ROBOTO_16_R_DEFAULT_TEXT = 2,
    FONT_KEY_ROBOTO_16_R_PANE_TEXT = 3,
    FONT_KEY_ROBOTO_18_R_DEFAULT_TEXT = 4,
    FONT_KEY_ROBOTO_18_R_PANE_TEXT = 5,
} font_key_e;
