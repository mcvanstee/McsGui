...
void color_checkbox_init(ColorCheckbox_s *p_colorCheckbox)
{
    ...
    base_setBmpKey(p_colorCheckbox, FILE_KEY_ICON_CHECKMARK);
...
static void color_checkbox_onDisplay(BaseComponent_s *p_baseComponent)
{
    ...
    if (p_baseComponent->focused)
    {
        ...
        borderColor = (theme ==  GuiTheme_Dark) ? COLOR_ACCENT_WHITE : COLOR_ACCENT_BLACK;
    }
    else
    {
...
{
    const GuiTheme_e theme = theme_getGuiTheme();
    Color_t borderColor = (theme ==  GuiTheme_Dark) ? COLOR_ACCENT_WHITE : COLOR_ACCENT_BLACK;
    ColorCheckbox_s *p_colorCheckbox = (ColorCheckbox_s *)p_baseComponent;
...
static void color_checkbox_selectionChanged(Checkbox_s *p_checkbox)
{
    ...
    if (p_checkbox->checked)
    {
        ...
        label_initBmpPosSize(
                &label, FILE_KEY_ICON_CHECKMARK,
                p_base->x, p_base->y,
                CHECKBOX_WIDTH, CHECKBOX_HEIGHT);
        base_setBackground(&label, theme_getPaneColor());
        base_setForeColor(&label, theme_getPaneTextColor());
        ...
        {
            const GuiTheme_e theme = theme_getGuiTheme();
            const Color_t color = (theme ==  GuiTheme_Dark) ? COLOR_ACCENT_WHITE : COLOR_ACCENT_BLACK;
