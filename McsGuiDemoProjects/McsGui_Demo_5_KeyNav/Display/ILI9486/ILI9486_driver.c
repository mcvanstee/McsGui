...
#define MEMORY_ACCESS_ROW_ADDRESS_ORDER 0x80u
#define MEMORY_ACCESS_COLUMN_ADDRESS_ORDER 0x40u
#define MEMORY_ACCESS_ROW_COLUMN_EXCHANGE 0x20u
#define MEMORY_ACCESS_VERTICAL_REFRESH_ORDER 0x10u
#define MEMORY_ACCESS_COLOR_ORDER 0x08u       /* 0 = RGB, 1 = BGR */
#define MEMORY_ACCESS_HORIZONTAL_REFRESH_ORDER 0x04u
...
static bool display_dr_setAddressWindow(const uint16_t x, const uint16_t y, const uint16_t width, const uint16_t height)
{
    ...
    display_hal_sendCommandData(DISPLAY_CMD_SET_COLUMN_ADDRESS, xData, 4u);
    display_hal_sendCommandData(DISPLAY_CMD_SET_ROW_ADDRESS, yData, 4u);
...
static void display_dr_setOrientation(const DisplayOrientation_e orientation)
{
    ...
    {
        case Portrait:
            memoryAccessRegData = MEMORY_ACCESS_COLUMN_ADDRESS_ORDER | MEMORY_ACCESS_HORIZONTAL_REFRESH_ORDER | MEMORY_ACCESS_COLOR_ORDER;
            break;
        case Landscape:
			memoryAccessRegData = MEMORY_ACCESS_ROW_COLUMN_EXCHANGE | MEMORY_ACCESS_COLOR_ORDER;
            break;
        case PortraitFlip:
            memoryAccessRegData = MEMORY_ACCESS_ROW_ADDRESS_ORDER | MEMORY_ACCESS_HORIZONTAL_REFRESH_ORDER | MEMORY_ACCESS_COLOR_ORDER;
            break;
        case LandscapeFlip:
			memoryAccessRegData = MEMORY_ACCESS_COLUMN_ADDRESS_ORDER | MEMORY_ACCESS_ROW_COLUMN_EXCHANGE | MEMORY_ACCESS_ROW_ADDRESS_ORDER | MEMORY_ACCESS_COLOR_ORDER;
            break;
    ...
    display_hal_sendCommandData(DISPLAY_CMD_MEMORY_ACCESS_CONTROL, &memoryAccessRegData, 1u);
}
