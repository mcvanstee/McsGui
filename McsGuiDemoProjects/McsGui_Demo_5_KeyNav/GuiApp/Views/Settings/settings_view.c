...
static void sv_create(View_s *p_view)
{
    ...
    PageButton_s *p_themeButton = gui_addPageButton(p_grid, FILE_KEY_ICON_BRUSH, FILE_KEY_TEXT_THEME, theme_view_navigateTo);
    gui_addPageButton(p_grid, FILE_KEY_ICON_PALETTE,FILE_KEY_TEXT_ACCENT_COLOR, accent_color_view_navigateTo);
    gui_addPageButton(p_grid, FILE_KEY_ICON_BRIGHTNESS, FILE_KEY_TEXT_BRIGHTNESS, brightness_view_navigateTo);
    PageButton_s *p_languageButton = gui_addPageButton(p_grid, FILE_KEY_ICON_GLOBAL, FILE_KEY_TEXT_LANGUAGE, language_view_navigateTo);
    PageButton_s *p_dateButton = gui_addPageButton(p_grid, FILE_KEY_ICON_AGENDA, FILE_KEY_TEXT_DATE, set_date_view_navigateTo);
    PageButton_s *p_timebutton = gui_addPageButton(p_grid, FILE_KEY_ICON_CLOCK, FILE_KEY_TEXT_TIME, set_time_view_navigateTo);
