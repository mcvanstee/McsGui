...
static void sv_create(View_s *p_view)
{
    ...
    gui_addPageButton(p_grid, FILE_KEY_ICON_BUTTON_BRUSH, FILE_KEY_TEXT_THEME, theme_view_navigateTo);
    ...
    gui_addPageButton(p_grid, FILE_KEY_ICON_BUTTON_GLOBAL, FILE_KEY_TEXT_LANGUAGE, language_view_navigateTo);
    gui_addPageButton(p_grid, FILE_KEY_ICON_BUTTON_AGENDA, FILE_KEY_TEXT_DATE, set_time_view_navigateTo);
    gui_addPageButton(p_grid, FILE_KEY_ICON_BUTTON_CLOCK, FILE_KEY_TEXT_TIME, set_time_view_navigateTo);
