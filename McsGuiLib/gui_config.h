...
#define GUI_USE_EXTERNAL_DISPLAY 0
 ...
 *----------------------------------------------------------------*/
#define GUI_CONFIG_RESET_BEFORE_NAVIGATE_TO 1
...
#define GUI_CONFIG_NUMBER_OF_PROPERTIES 0
 ...
 *  file properties generated by the GUI Designer, this value must greater then or match the
 *  FS_MAX_FILE_PROPERTIES value in fs_file_search.h
 */

#define GUI_CONFIG_USE_BITMAP_COLORS 0
/* This option adds the bitmap colors to the BaseComponent_s
 *  0: Do not use bitmap colors
 *  1: Use bitmap colors
 */
