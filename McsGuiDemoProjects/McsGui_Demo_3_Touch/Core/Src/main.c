...
/* USER CODE BEGIN PV */
SPI_HandleTypeDef *g_p_displaySPI = &hspi1;
TIM_HandleTypeDef *g_p_displayBacklightPWMTimer = &htim4;
/* USER CODE END PV */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BTN_DOWN_Pin BTN_OK_Pin BTN_RIGHT_Pin BTN_UP_Pin
                           BTN_LEFT_Pin */
  GPIO_InitStruct.Pin = BTN_DOWN_Pin|BTN_OK_Pin|BTN_RIGHT_Pin|BTN_UP_Pin
                          |BTN_LEFT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
