...
{
    base_setProperty(p_component, FILE_PROPERTY_ACCENT_COLOR, m_p_themeSetting->cursorColorProperty);
}
...
{
    switch (m_p_themeSetting->cursorColorProperty)
    {
        case PROPERTY_ACCENT_COLOR_VALUE_RED:
            return COLOR_ACCENT_RED;
        case PROPERTY_ACCENT_COLOR_VALUE_GREEN:
...
{
    return m_p_themeSetting->cursorColorProperty;
}
...
{
    m_p_themeSetting->cursorColorProperty = value;
}
