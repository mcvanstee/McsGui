...
static void msmv_create(View_s *p_view)
{
    ...
    theme_setPaneTextBlock(p_tempTextBlock);
    ...
    theme_setPaneText(p_tempUnitLabel);
    ...
    FooterButton_s *p_footerBackButton = gui_addFooterButton(p_footer, FILE_KEY_ICON_ARROW_BACK, mainview_navigateTo);
